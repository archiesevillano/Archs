...
const MissingPage = () => {
    ...
    return (
        <div className="missingPageComponent flex flex-col sm:items-center items-start justify-center sm:px-0 px-10">
            ...
            <h1 className="font-bold text-5xl mb-4 w-full">Page not found</h1>
            <p className="text-sm opacity-80 font-quicksand mb-3">Seems like the page that you&apos;re trying to visit does not exist.</p>
