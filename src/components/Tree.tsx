    ...
    return (
        <div className="tree relative py-10 md:w-[500px] max-w-[370px] w-full overflow-hidden translate-x-[20px]">
            ...
            <div className="pole absolute top-0 left-0 bg-random-gray opacity-50 w-[5px] h-full translate-x-[10px]">
                <div className="startPole border-2 border-white absolute z-1 top-[0] left-[10%] rounded-full w-[15px] h-[15px] bg-random-gray translate-x-[-50%]" ></div>
                <div className="endPole border-2 border-white absolute z-1 bottom-[0] left-[10%] rounded-full w-[15px] h-[15px] bg-random-gray translate-x-[-50%]"></div>
            </div>
